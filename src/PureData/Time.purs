module PureData.Time
  ...
  , adjust
  , diff
  , module PureData.Time.Component
  ) where
...
import PureData.Time.Component (Hour, Millisecond, Minute, Second)
import PureData.Time.Duration (class Duration, Days(..), Milliseconds(..), fromDuration, negateDuration, toDuration)
