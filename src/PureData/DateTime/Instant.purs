module PureData.DateTime.Instant
  ( Instant
  , instant
  , unInstant
  , fromDateTime
...
import PureData.DateTime (Millisecond, Second, Minute, Hour, Day, Year, DateTime(..), Date, Time(..), canonicalDate, millisecond, second, minute, hour, day, month, year)
import Data.Enum (fromEnum, toEnum)
import Data.Function.Uncurried (Fn7, runFn7)
import Data.Maybe (Maybe(..), fromJust)
import PureData.Time.Duration (Milliseconds(..))
